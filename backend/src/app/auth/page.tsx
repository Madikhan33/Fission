            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white border border-zinc-200 rounded-lg p-8 shadow-sm">
                        ...
                        <div className="flex items-center justify-between">
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input
                                    ...
                                    className="w-4 h-4 border-zinc-300 rounded focus:ring-2 focus:ring-black"
                                />
                                <span className="text-sm text-zinc-600">Remember me</span>
                            </label>
                            <a href="#" className="text-sm text-black hover:text-zinc-700 font-medium">
                                Forgot password?
                            </a>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button className="flex items-center justify-center gap-2 px-4 py-2.5 border border-zinc-200 rounded-lg hover:bg-zinc-50 transition-colors text-sm font-medium">
                    ...
                    <div className="mt-6 text-center text-sm text-zinc-600">
                        ...
                        <a href="#" className="text-black font-medium hover:text-zinc-700">
                            Sign up
                        </a>
                    </div>
                </div>
